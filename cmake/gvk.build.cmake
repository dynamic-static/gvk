...
function(gvk_setup_target)
    ...
    set_target_properties(${ARGS_TARGET} PROPERTIES FOLDER "${gvk-ide-folder}/${ARGS_FOLDER}")
endfunction()
...
function(gvk_add_layer)
    ...
    if(ARGS_INTERFACE_FILES)
        ...
        set_target_properties(${ARGS_TARGET}-interface PROPERTIES FOLDER "${gvk-ide-folder}/${ARGS_FOLDER}")
